...
| `/publications`      | Our Work: Publications — journal-style index (search + type filter) and paper pages: abstract, numbered-author affiliations with member portraits, bibliographic metadata, DOI, keywords, first-page preview, full PDF viewer, citations (APA/IEEE/MLA/Chicago/BibTeX/RIS, copy + download) | Complete — driven by the Publications CMS                   |
...
- **Real:** homepage hero, Core Competencies, nav/menu system, theme toggle, smooth scrolling, all page scaffolding, CI/CD, the Articles, Members, and Publications CMS collections (editable from `/admin` with the passphrase).
