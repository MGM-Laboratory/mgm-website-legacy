...
- **Real:** homepage hero, Core Competencies, nav/menu system, theme toggle, smooth scrolling, all page scaffolding, CI/CD, the Articles, Members, Publications, Careers, and Research CMS collections (editable from `/admin` with the passphrase).
